// List of games and proxies for easy editing
window.GAME_LIST = [
...
window.PROXY_LIST = [
  { name: "Nano", url: "https://nano-proxy.example.com" },
  { name: "Termina Proxy", url: "https://termina-proxy.example.com" },
  { name: "Node Unblocker", url: "https://ultrablue-neon.vercel.app/" }
];
